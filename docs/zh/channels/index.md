...
学习如何在各个沟通渠道中充分发挥 OpenMax AI 员工的能力。
...
| [LINE](./line) | 日本 / 台湾 / 泰国用户、个人及商业使用 | ✅ 可用 |
| [Web 控制台](./web-console) | 浏览器访问、快速测试 | ✅ 可用 |

## 通用技巧

- **群聊场景**：使用 `@你的Bot名` 在群中唤起 AI 员工
- **私信模式**：直接发送消息，无需 @mention
- **多渠道**：同一个 AI 员工可以同时连接多个渠道
- **上下文保持**：AI 员工在每个渠道内保持对话上下文
